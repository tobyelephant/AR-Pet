...
struct SpawnableManager_tC029DDD2FD6DB3F1396C3546F6F6A7F53A395730  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
	...
	int32_t ___numberOfPetsAllowed_9;
	// System.Int32 SpawnableManager::currentNumberOfCats
	int32_t ___currentNumberOfCats_10;
	// UnityEngine.Animator SpawnableManager::petAnim
	Animator_t8A52E42AE54F76681838FE9E632683EF3952E883* ___petAnim_11;
	// UnityEngine.XR.ARFoundation.ARSessionOrigin SpawnableManager::ar_session_origin
	ARSessionOrigin_tE7B28A1A19500BCC02711397A19E330425830BC3* ___ar_session_origin_12;
};
...
IL_00c7:
	...
	}
	{
		...
		NullCheck(L_31);
		petMoveTo_t0D96A3D1B041A2B786BC86FF74186536C6129A26* L_32;
		L_32 = GameObject_GetComponent_TispetMoveTo_t0D96A3D1B041A2B786BC86FF74186536C6129A26_m85AC96D3811F0451C75BAD66507121B5BB3391F9(L_31, GameObject_GetComponent_TispetMoveTo_t0D96A3D1B041A2B786BC86FF74186536C6129A26_m85AC96D3811F0451C75BAD66507121B5BB3391F9_RuntimeMethod_var);
		...
		NullCheck(L_32);
		petMoveTo_StartMove_m0E0327E19A480DF41A29C866E2C6D5505D20F295(L_32, L_36, NULL);
		// petAnim = spawnedObject.GetComponent<Animator>();
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_37 = __this->___spawnedObject_8;
		NullCheck(L_37);
		...
		__this->___petAnim_11 = L_38;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___petAnim_11), (void*)L_38);
	...
	{
		Animator_t8A52E42AE54F76681838FE9E632683EF3952E883* L_40 = __this->___petAnim_11;
		NullCheck(L_40);
		AnimatorStateInfo_t1F47379289C7CE7FD588FBC3BBD79A777243B6B2 L_41;
		L_41 = Animator_GetCurrentAnimatorStateInfo_mD5B526FA605F6CFBC31B7DE36740F6AD1E534CAD(L_40, 0, NULL);
		V_4 = L_41;
		bool L_42;
		L_42 = AnimatorStateInfo_IsName_mB936F493D6BDDB9372C8E9D813CE0416B002C4D0((&V_4), _stringLiteralA5734F678E2F0CB4BC959F0C67DE3A0001D3D09B, NULL);
		if (!L_42)
		{
			goto IL_015b;
		}
	}
	{
		...
		Animator_t8A52E42AE54F76681838FE9E632683EF3952E883* L_43 = __this->___petAnim_11;
		NullCheck(L_43);
		Animator_Play_m0F6A9F84B2E256E644D56C34A7A9BD622CB00FF9(L_43, _stringLiteralC2384F8512F3E5B28F63D5985E48EA5FCF1155F5, NULL);
		return;
	}
...
IL_015b:
	...
	{
		Animator_t8A52E42AE54F76681838FE9E632683EF3952E883* L_45 = __this->___petAnim_11;
		NullCheck(L_45);
		...
		V_4 = L_46;
		bool L_47;
		L_47 = AnimatorStateInfo_IsName_mB936F493D6BDDB9372C8E9D813CE0416B002C4D0((&V_4), _stringLiteralA5734F678E2F0CB4BC959F0C67DE3A0001D3D09B, NULL);
		if (!L_47)
		{
			goto IL_018f;
		}
	}
	{
		...
		Animator_t8A52E42AE54F76681838FE9E632683EF3952E883* L_48 = __this->___petAnim_11;
		NullCheck(L_48);
		Animator_Play_m0F6A9F84B2E256E644D56C34A7A9BD622CB00FF9(L_48, _stringLiteral4ECA2B7EE06069BD089C7E1C2347E000D1DA2662, NULL);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SpawnableManager_SpawnPrefab_mF522EF88B8AAB43C88ADC75967DDEE81030F05DB (SpawnableManager_tC029DDD2FD6DB3F1396C3546F6F6A7F53A395730* __this, Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 ___spawnPosition0, const RuntimeMethod* method) 
{
	...
	memset((&V_0), 0, sizeof(V_0));
	{
		...
		int32_t L_0 = __this->___currentNumberOfCats_10;
		int32_t L_1 = __this->___numberOfPetsAllowed_9;
	...
	}
	{
		...
		int32_t L_2 = __this->___currentNumberOfCats_10;
		__this->___currentNumberOfCats_10 = ((int32_t)il2cpp_codegen_add(L_2, 1));
		...
		__this->___spawnedObject_8 = L_6;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___spawnedObject_8), (void*)L_6);
		// spawnedObject.transform.LookAt(arCam.transform);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_7 = __this->___spawnedObject_8;
		NullCheck(L_7);
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_8;
		L_8 = GameObject_get_transform_m0BC10ADFA1632166AE5544BDF9038A2650C2AE56(L_7, NULL);
		Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* L_9 = __this->___arCam_7;
		NullCheck(L_9);
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_11 = __this->___spawnedObject_8;
		NullCheck(L_11);
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_18 = __this->___spawnedObject_8;
		NullCheck(L_18);
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_19;
...
IL_009d:
	{
		// ar_session_origin.GetComponent<ARPlaneManager>().enabled = false;
		ARSessionOrigin_tE7B28A1A19500BCC02711397A19E330425830BC3* L_23 = __this->___ar_session_origin_12;
		NullCheck(L_23);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SpawnableManager__ctor_m5E989BEEF4E8A6A12828E117976ED1043ACAA1ED (SpawnableManager_tC029DDD2FD6DB3F1396C3546F6F6A7F53A395730* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->___numberOfPetsAllowed_9 = 1;
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
	}
}
